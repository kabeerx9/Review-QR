        ...
        {!shop ? (
          ...
          <>
            ...
            {data.googleConnected ? (
              <div className="bg-white border border-emerald-200 rounded-3xl p-6 shadow-sm flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-black text-slate-900">Google Business Connected</p>
                    <p className="text-xs font-medium text-slate-500">
                      Auto-reply is {data.autoReplyEnabled ? "enabled" : "disabled"} · Reviews are being monitored
                    </p>
                  </div>
                </div>
                <span className="rounded-full border border-emerald-200 bg-emerald-50 px-4 py-1.5 text-[10px] font-black uppercase tracking-widest text-emerald-700">
                  Active
                </span>
              </div>
            ) : (
              <a
                ...
                className="group block bg-white border border-slate-200 rounded-3xl p-6 shadow-sm hover:border-blue-300 hover:shadow-md transition-all"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-blue-50 border border-blue-100 rounded-2xl flex items-center justify-center shadow-inner group-hover:bg-blue-100 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium text-slate-500">
                        Enable auto-reply to reviews &amp; list your locations
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-bold text-slate-600 group-hover:border-blue-200 group-hover:bg-blue-50 group-hover:text-blue-700 transition-colors">
                    Connect
